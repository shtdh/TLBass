...
his project contains two core programs for training individual foundation models and for model fusion (ensemble). Below is a description of each program and instructions for use.
